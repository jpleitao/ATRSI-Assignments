load('/media/jpleitao/Data/PhD/PDCTI/ATRSI/ATRSI-Assignments/TP1/data/ARX_Input2.mat');

time = ARX_Input2(1, :);
ts = time(2) - time(1);
len = length(ARX_Input2(2,:));
...
z_total = iddata(ARX_Output2(2,:)', ARX_Input2(2, :)', ts);

z_est = iddata(ARX_Output2(2, 1:estimation_size)', ARX_Input2(2, 1:estimation_size)', ts);
z_est.Period = number_periods_e;
z_est.Tstart = 0;

z_val = iddata(ARX_Output2(2, estimation_size+1:end)', ARX_Input2(2, estimation_size+1:end)', ts);
...
save('arx2.mat', 'estimator', 'sys');

% =========================== Try estimator ARX1 ========================

load('/media/jpleitao/Data/PhD/PDCTI/ATRSI/ATRSI-Assignments/TP1/code/arx1/arx1.mat');
